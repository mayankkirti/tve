...
export default function App() {
  ...
  const { jobs, addJob, removeJob, killJob, startQueue } = useRenderQueue();

  // Auto-start next queued job when one finishes
  useEffect(() => {
  ...
  return (
    <div className="flex h-screen bg-black text-zinc-100 font-sans overflow-hidden">
      ...
      {/* Main Preview Area */}
      <main className="flex-1 flex flex-col items-center justify-center relative p-8 overflow-y-auto">
        ...
        >
             ...
             <div 
                 ...
                 style={{ 
                    ...
                    fontSize: `${1.25 * (config.textSize / 100)}rem` 
                 }}
             >
                 {config.channelName}
             </div>
             ...
             <div className="absolute bottom-6 left-6 text-left z-10 drop-shadow-md">
                 {config.albumName && (
                     <div 
                         ...
                         style={{ 
                            fontFamily: `"${config.textFont}", sans-serif`,
                            fontSize: `${0.875 * (config.textSize / 100)}rem` 
                         }}
                     >
                         {config.albumName}
                     </div>
                 ...
                 <div 
                     ...
                     style={{ 
                        fontFamily: `"${config.textFont}", sans-serif`,
                        fontSize: `${1.125 * (config.textSize / 100)}rem` 
                     }}
                 >
                 ...
                 <div 
                     ...
                     style={{ 
                        fontFamily: `"${config.textFont}", sans-serif`,
                        fontSize: `${1.5 * (config.textSize / 100)}rem` 
                     }}
                 >
        ...
        <div className="w-full max-w-4xl mt-8 bg-zinc-900 border border-zinc-800 rounded-lg p-4 flex flex-col gap-2 shrink-0">
            ...
            <div className="w-full flex justify-between text-[10px] text-zinc-600 font-mono mt-1">
                ...
                <span>01:00:00.0</span>
                <span>02:00:00.0</span>
                <span>03:00:00.0</span>
                <span>...</span>
            </div>
        </div>
